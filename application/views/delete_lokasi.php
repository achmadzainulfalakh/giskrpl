...
<div class="container">
	<div class="row">
		...
		<?=form_open(base_url()."lokasi/delete-lokasi.html",$attributes) ?>
			<?php
			if(!$dataajax){
			...
			<div class="col-lg-12">
				<div class="text">
					<h2 class="section-title">Delete Lokasi<button class="btn btn-danger btn-lg pull-right" type="submit" name="submit" value="delete">Delete</button></h2>
